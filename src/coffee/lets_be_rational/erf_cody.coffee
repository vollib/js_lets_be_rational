...
class erf_cody
    ...
    d_int = (x) ->
        return if x > 0 then Math.floor(x) else -Math.floor(-x)
    ...
    C = [0.564188496988670089, 8.88314979438837594, 66.1191906371416295, 298.635138197400131, 881.95222124176909,
    ...
    P = [0.305326634961232344, 0.360344899949804439, 0.125781726111229246, 0.0160837851487422766, 6.58749161529837803e-4,
...
# <                YSQ = AINT(Y*SIXTEN)/SIXTEN >
    ...
    fix_up_for_negative_argument_erf_etc = (jint, result, x) ->
# ------------------------------------------------------------------
...
if module?
    module.exports = new erf_cody()
window.erf_cody = new erf_cody()
